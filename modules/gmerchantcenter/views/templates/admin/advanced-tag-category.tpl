						...
						<td class="label_tag_categories_value">{l s='Set EXCLUDED DESTINATION tags: for each product default category, select in the drop and down menu the advertising channel on which you DO NOT want products of this category to be displayed. You can select several channels by holding down the CTRL (or CMD) key. To assign the same tag to all categories, click on one of the opposite buttons -------->' mod='gmerchantcenter'}</td>			
							<td>
								<select multiple name="set_excluded_destination_bulk_action" class="set_excluded_destination_bulk_action">
									...
									<option value="actions">{l s='Shopping Actions' mod='gmerchantcenter'}</option>
									<option value="display">{l s='Display Ads' mod='gmerchantcenter'}</option>
									<option value="local">{l s='Local Shopping' mod='gmerchantcenter'}</option>
									<option value="surface">{l s='Surfaces across Google' mod='gmerchantcenter'}</option>
								</select>
							<td>
						...
						<td>
							...
							<div class="value_sizeType">
								...
								<select class="sizeType" name="sizeType[{$cat.id_category|intval}]" id="sizeType{$cat.id_category|intval}">
									...
									<option value="plus"{if $cat.sizeType=="plus"} selected{/if}>{l s='Plus' mod='gmerchantcenter'}</option>
									<option value="big and tall"{if $cat.sizeType=="big and tall"} selected{/if}>{l s='Big and tall' mod='gmerchantcenter'}</option>
							...
							<div class="value_excluded_destination">
								<select multiple name="excluded_destination[{$cat.id_category|intval}][]" class="excluded_destination">
									...
									<option {if in_array('actions', $cat.excluded_destination)} selected {/if} value="actions">{l s='Shopping Actions' mod='gmerchantcenter'}</option>
									<option {if in_array('display', $cat.excluded_destination)} selected {/if} value="display">{l s='Display Ads' mod='gmerchantcenter'}</option>
									<option {if in_array('local', $cat.excluded_destination)} selected {/if} value="local">{l s='Local Shopping' mod='gmerchantcenter'}</option>
									<option {if in_array('surface', $cat.excluded_destination)} selected {/if} value="surface">{l s='Surfaces across Google' mod='gmerchantcenter'}</option>
								</select>
							<div>
						</td>
					</tr>
			...
			function handleOptionToDisplay(sTagType) {
				...
				switch (sTagType) {
					case 'material':
						...
						aHide = ['#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_gender', '#bulk_action_tagadult', '.value_pattern', '.value_agegroup', '.value_gender', '.value_tagadult', '#bulk_action_sizeType', '.value_sizeType', '#bulk_action_sizeSystem', '.value_sizeSystem', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'pattern':
						oGmc.doSet('#set_tag', 'pattern');
						aShow = ['#bulk_action_pattern', '.value_pattern'];
						aHide = ['#bulk_action_material', '#bulk_action_adult', '#bulk_action_gender', '#bulk_action_tagadult', '.value_material', '.value_agegroup', '.value_gender', '.value_tagadult', '#bulk_action_sizeType', '.value_sizeType', '#bulk_action_sizeSystem', '.value_sizeSystem', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'agegroup':
						oGmc.doSet('#set_tag', 'agegroup');
						aShow = ['#bulk_action_adult', '.value_agegroup'];
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_gender', '#bulk_action_tagadult', '.value_material', '.value_pattern', '.value_gender', '.value_tagadult', '#bulk_action_sizeType', '.value_sizeType', '#bulk_action_sizeSystem', '.value_sizeSystem', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'gender':
						oGmc.doSet('#set_tag', 'gender');
						aShow = ['#bulk_action_gender', '.value_gender'];
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_tagadult', '.value_material', '.value_pattern', '.value_agegroup', '.value_tagadult', ,'#bulk_action_sizeType', '.value_sizeType', '#bulk_action_sizeSystem', '.value_sizeSystem', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'adult':
						oGmc.doSet('#set_tag', 'adult');
						aShow = ['#bulk_action_tagadult', '.value_tagadult'];
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_gender', '.value_material', '.value_pattern', '.value_agegroup', '.value_gender', '#bulk_action_sizeType', '.value_sizeType', '#bulk_action_sizeSystem', '.value_sizeSystem', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'sizeType':
						oGmc.doSet('#set_tag', 'sizeType');
						aShow = ['#bulk_action_sizeType', '.value_sizeType'];
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_gender', '.value_material', '.value_pattern', '.value_agegroup', '.value_gender', '#bulk_action_tagadult', '.value_tagadult', '#bulk_action_sizeSystem', '.value_sizeSystem', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'sizeSystem':
						oGmc.doSet('#set_tag', 'sizeSystem');
						aShow = ['#bulk_action_sizeSystem', '.value_sizeSystem'];
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_gender', '.value_material', '.value_pattern', '.value_agegroup', '.value_gender', '#bulk_action_tagadult', '.value_tagadult', '#bulk_action_sizeType', '.value_sizeType', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					case 'excluded_destination':
						...
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_gender', '.value_material', '.value_pattern', '.value_agegroup', '.value_gender', '#bulk_action_tagadult', '.value_tagadult', '#bulk_action_sizeType', '.value_sizeType', '#bulk_action_sizeSystem', '.value_sizeSystem'];
						break;
					case '0':
						aHide = ['#bulk_action_material', '#bulk_action_pattern', '#bulk_action_adult', '#bulk_action_gender', '#bulk_action_tagadult', '.value_material', '.value_pattern', '.value_agegroup', '.value_gender', '.value_tagadult', '#bulk_action_excluded_destination', '.value_excluded_destination'];
						break;
					default:
						break;
				}
