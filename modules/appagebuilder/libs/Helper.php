...
class apPageHelper
{
    ...
    public static function setGlobalVariable($context)
    {
        ...
        if (!$global_variable) {
            ...
            $context->smarty->assign(array(
                ...
                'slide_image' => Configuration::get('APPAGEBUILDER_SLIDE_IMAGE'),           //slide image on mobile(product list)
    ...
    public static function getImgThemeDir($folder = 'images', $path = '')
    {
        ...
        if (!$img_theme_dir || !isset($img_theme_dir[$folder])) {
            $img_theme_dir[$folder] = _PS_ALL_THEMES_DIR_.apPageHelper::getThemeName().'/'.$path.'/'.$folder.'/';
        }
