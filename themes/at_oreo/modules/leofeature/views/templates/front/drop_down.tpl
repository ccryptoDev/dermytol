		...
		<div class="leo-dropdown-cart-content clearfix">
			...
			{if $only_total != 1}
				<div class="leo-cart-dropdown-action clearfix">
					<input type="hidden" name="cart-drop-test" value="{Context::getContext()->language->iso_code}">
					...
					<a class="cart-dropdow-button cart-dropdow-checkout btn btn-primary btn-outline" href="{$order_url}">
